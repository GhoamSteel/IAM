...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'GhoamSteel2933' and user == 'GhoamSteel':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
...
def lodhirt():
    lodhirt = [
     'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'PAJAOQ', '      ', 'PAJAOQ', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL', '      ', 'GHOAMSTEEL\n']
    for o in lodhirt:
...
if pilih == 1:
	...
	os.system('xdg-open User = GhoamSteel Pass = GhoamSteel2933')
elif pilih == 0:
	os.system('clear')
